...
def main():
    ...
    name = "Evelyn" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("I'm currently a junior in California. I enjoy doing robotics (FTC), chemistry, and playing the violin in my free time!")
